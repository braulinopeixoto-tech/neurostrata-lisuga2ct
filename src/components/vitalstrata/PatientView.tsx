...
import { HeartPulse, Moon, Zap, ActivitySquare, CheckCircle2 } from 'lucide-react'
  ...
  return (
    <div className="space-y-6 animate-fade-in-up max-w-4xl mx-auto">
        ...
        <CardContent className="p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
          <div className="space-y-3">
            <Badge className="bg-white/20 text-white hover:bg-white/30 border-none px-3 py-1 text-xs">
              <HeartPulse className="w-3.5 h-3.5 mr-1.5" /> VitalStrata™ Pessoal
            </Badge>
            ...
            <p className="text-indigo-100 max-w-md text-base leading-relaxed">
              O VitalScore reflete a capacidade do seu corpo e cérebro de se adaptar ao estresse e
              manter a performance diária.
            </p>
          </div>
      ...
      <h3 className="text-xl font-bold text-slate-800 pt-4 px-2">
        Insights Acionáveis para Esta Semana
      </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="shadow-sm border-t-4 border-t-amber-500 hover:-translate-y-1 transition-transform">
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2">
              <Moon className="w-5 h-5 text-amber-500" /> Prioridade: Sono
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-slate-600 mb-4">
              Seus dados contextuais indicam que noites mal dormidas estão reduzindo sua reserva
        ...
        <Card className="shadow-sm border-t-4 border-t-emerald-500 hover:-translate-y-1 transition-transform">
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2">
              <ActivitySquare className="w-5 h-5 text-emerald-500" /> Consistência
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-slate-600 mb-4">
              Ótimo trabalho! Seu eixo neurofuncional está estável graças à adesão ao protocolo de
              neuromodulação.
            </p>
            <Badge
              variant="outline"
            ...
            >
              <CheckCircle2 className="w-3 h-3" /> Manter Padrão
            </Badge>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-sm border-t-4 border-t-blue-500 hover:-translate-y-1 transition-transform">
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2">
              <Zap className="w-5 h-5 text-blue-500" /> Próximo Passo
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-slate-600 mb-4">
              Continue o acompanhamento contínuo (Pós-Alta). A próxima reavaliação automática
              acontecerá em 10 dias.
            </p>

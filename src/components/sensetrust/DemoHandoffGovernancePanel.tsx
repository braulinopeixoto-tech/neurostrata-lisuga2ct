import type { SenseTrustDemoHandoffGovernance } from '@/types/sensetrust/partner-demo-kit'

export function DemoHandoffGovernancePanel({ items }: { items: SenseTrustDemoHandoffGovernance[] }) {
  return (
    <section className="rounded-md border bg-white p-5 shadow-sm">
      <p className="text-lg font-black text-slate-950">Demo handoff governance</p>

...
import { PHQ9History } from '@/components/patient/PHQ9History'
import { GAD7History } from '@/components/patient/GAD7History'
...
export function PatientFeedbackTab({ patient }: { patient: any }) {
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-5xl">
      ...
      <Tabs defaultValue="daily" className="w-full mt-6">
        <TabsList className="w-full grid grid-cols-2 md:grid-cols-5 h-auto p-1 bg-muted rounded-lg mb-6">
          <TabsTrigger value="daily">Diário</TabsTrigger>
          <TabsTrigger value="dass21">DASS-21</TabsTrigger>
        ...
        <TabsContent value="daily">
          <Card className="shadow-sm border-t-4 border-t-primary">
            <CardHeader>
              ...
              <CardDescription>
                Gráfico evolutivo de humor, foco, qualidade de sono e níveis de ansiedade (escala 1
                a 5).
              </CardDescription>
            </CardHeader>
            <CardContent>
              {feedbacks.length === 0 ? (
                <div className="p-12 text-center text-muted-foreground border border-dashed rounded-lg bg-muted/20">
                  Nenhum feedback registrado pelo paciente ainda. O paciente pode acessar o Portal
                  para realizar a autoavaliação diária.
                </div>
              ) : (
                <div className="space-y-8">
                  ...
                  <div className="p-5 bg-blue-50 border border-blue-100 rounded-xl">
                    ...
                    <p className="text-sm text-blue-800 leading-relaxed">
                      Os sintomas relatados alimentam diretamente os{' '}
                      <strong>Blocos 4, 6 e 7</strong> da sua Avaliação Multidimensional (Perfil
                      Comportamental, RDoC e Big Five), ajustando o baseline de risco clínico
                      dinamicamente na Matriz Neurofuncional.
                    </p>
                  </div>
